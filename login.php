...
<h1 class="alert alert-success rounded-0"><?php echo $name = "MCB Bank"; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Rhino Club</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
